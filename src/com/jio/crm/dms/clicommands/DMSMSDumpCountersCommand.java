...
public class DMSMSDumpCountersCommand extends DMSMSAbstractCLICommand {
	...
	public String execute(DMSMSCLIPojo cliData) {
		...
		try {
			...
			.getExceptionLogBuilder(e, "Dump counters error", this.getClass().getName(),
					Thread.currentThread().getStackTrace()[1].getMethodName())
			.writeExceptionLog();
