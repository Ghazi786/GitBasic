...
public class MicrosecondsSyncClockResolution extends AbstractClockResolution implements ClockResolution {
  ...
  private static  MicrosecondsSyncClockResolution syncClockResolution = new MicrosecondsSyncClockResolution();
  ...
  private MicrosecondsSyncClockResolution() {
	...
	public static MicrosecondsSyncClockResolution getInstance() {
		if (syncClockResolution == null) {
			syncClockResolution = new MicrosecondsSyncClockResolution();
		}
		return syncClockResolution;
	}
