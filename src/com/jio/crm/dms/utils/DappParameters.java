...
/**
 * this class contains Constants which are used for Mbean manager
 *
 */
public class DappParameters {
	/***********************************************************************/
	/**********************Parameters***************************************/
	/***********************************************************************/
	
	public static final String DUMP_PATH_PARAMS = System.getProperty("user.dir") + File.separator +".."+File.separator+"dumps"+
			File.separator + "configuration_parameters";
	public static final String DUMP_PATH_COUNTERS = System.getProperty("user.dir") + File.separator  +".."+ File.separator+"dumps"+
			 File.separator + File.separator + "counters";
